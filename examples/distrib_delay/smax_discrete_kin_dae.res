...
1NONLINEAR MIXED EFFECTS MODEL PROGRAM (NONMEM) VERSION 7.5.1
 ...
 PROBLEM NO.:         1
 Discrete Delay on Smax Drug Responsive Input function kin using dae
...
1DOUBLE PRECISION PREDPP VERSION 7.5.1
 ...
 GENERAL NONLINEAR KINETICS MODEL WITH EQUILIBRIUM COMPARTMENTS (RADAR5, ADVAN17)
