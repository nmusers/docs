...
parameters be used to set flags for DES. (See [[file:/docs/cookbook/mtime/][Model Time examples]]).
...
(See [[file:/docs/reference-manual/abbr/#pred_ignore_data_block][PRED_IGNORE_DATA]] block)
...
See "Reference Manual: $PK" for details.
...
See also Guide VI, section VI.A , Figure 37
...
See [[file:/docs/reference-manual/api/variables/#comact][COMACT]], [[file:/docs/reference-manual/api/variables/#comres-comsav][COMSAV]] for details.
