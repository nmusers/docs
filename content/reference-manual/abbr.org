...
- Certain special variables: RPTO, RPTON and PRDFL - with the
  ...
  finalization block)  -  with  superproblems  or subproblems (See
  SKIP).
...
(See @@html:<a href="/docs/reference-manual/api/variables/">variables in NONMEM modules</a>@@, NONMEM_modules, PREDPP_modules).
