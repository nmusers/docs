...
*** AMT and RATE
 ...
 AMT must be 0 for "steady-state with constant infusion" dose or reset-
 dose event records.
...
*** CONT
 ...
 record to span several data records.  It is useful when more than NON-
 MEM's maximum number of data items per record are needed to describe a
...
NONMEM data set
 ...
 version) are divided by 24.  (See @@html:<a href="docs/reference-manual/control-records/data/">$DATA</a>@@).
