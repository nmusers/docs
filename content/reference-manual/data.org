...
*** ADDL
 ...
 describes how many additional doses, exactly like the present ("initiating") dose, should be given.  The interdose interval (II) data  item
 ...
 (See @@html:<a href="/docs/techniques/steady_state/">empirical steady state</a>@@).
...
#+end_src
 ...
 PK parameters that are relevant to ADDL doses; (See @@html:<a href="/docs/reference-manual/control-records/bind/">$BIND</a>@@).
...
RATE  labels  PREDPP's dose rate (RATE) data item.  The dose rate data
 ...
 - >0:   The  dose  is  an infusion, and the value of RATE gives its rate. If this is not a steady-state infusion, the AMT data item must be positive also.  If this is a steady-state dose event record, both AMT and RATE may be 0; (See @@html:<a href="/docs/reference-manual/data/#ss-dose">SS dose</a>@@).
...
| ADVAN12 |                        1 |                               2 |
 ...
 (See @@html:<a href="/docs/reference-manual/data/#cmt-pcmt">CMT</a>@@, @@html:<a href="/docs/reference-manual/control-records/model/">$MODEL</a>@@, @@html:<a href="/docs/reference-manual/api/subroutines/#model">MODEL</a>@@).
...
NONMEM data set
 ...
 case all interdose interval data items (obtained after clock time conversion) are divided by 24.  (See @@html:<a href="docs/reference-manual/control-records/data/">$DATA</a>@@).
...
four kinds of values.
  ...
  - RATE>0:   the  dose  is  an infusion, and the value of RATE gives its rate.
      ...
      AMT and RATE may be 0; (See @@html:<a href="/docs/reference-manual/data/#ss-dose">SS dose</a>@@).
...
:END:
 ...
 - 1:    The  data record serves as a template record, aiding in the
   ...
   the @@html:<a href="/docs/reference-manual/control-records/omit/">$OMIT record</a>@@.)  The average is a two-stage average; it is the average of within-individual averages.
 ...
 (See data average example, @@html:<a href="/docs/user-guide/advanced/abbr_block/#data-average-block">data average block</a>@@).
...
:END:
 ...
 REPL_ may be used with the $DATA ... REPL option, which replicates
 the entire data set REPL=n times.  If both are used the  REPL_  data
 item applies first, and the REPL option applies second. See REPL
 option of $DATA record. REPL_ and the @@html:<a href="/docs/reference-manual/control-records/data/#repl">REPL option</a>@@  are meant to be used with $SIMULATION or $DESIGN.
...
:END:
 ...
 The @@html:<a href="/docs/reference-manual/data/#cmt-pcmt">CMT</a>@@ data item applies to steady-state doses as to transient doses.
...
*** TIME
 ...
 data) is set to 0.  Subsequent times in the NONMEM data set are calculated relative to that time.  (See date data item).
...
#+end_src
 ...
 The  @@html:<a href="docs/reference-manual/control-records/data/">$DATA</a>@@ record may include the option TRANSLATE=(TIME/24), in which case all relative times (obtained after  clock  time  conversion)  are divided by 24.
