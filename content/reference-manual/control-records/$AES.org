...
@@html:<a href="/docs/reference-manual/control-records/subroutines/#advan9-15-17">ADVAN9, ADVAN15 and ADVAN17</a>@@.

(See @@html:<a href="/docs/reference-manual/control-records/aesinit/">$AESINIT</a>@@).
...
between the subscripts and the equilibrium compartments. At least one such quantity must be computed.
...
See @@html:<a href="/docs/reference-manual/abbr/">abbreviated code</a>@@ for general rules.
...
** REFERENCES
(See @@html:<a href="/docs/reference-manual/api/subroutines/#AES-routine">AES</a>@@)
