...
** DISCUSSION
The  $AES record is used to compute algebraic expressions which can be regarded as specifying equilibrium kinetics.  It is used with PREDPP's ADVAN9 and ADVAN15 and ADVAN17.
(See $AESINITIAL).
...
- Global Variables in Modules. The following are of particular interest.
