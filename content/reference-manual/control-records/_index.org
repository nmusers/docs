...
1. NONMEM  loads information from a @@html:<a href="/docs/reference-manual/files/#msf">Model Specification File</a>@@, if $MSFI
...
There  is  no  NMTRAN  error  checking on the RFORMAT and LFORMAT
      ...
      to  produce  a @@html:<a href="/docs/reference-manual/files/#msf">Model Specification File</a>@@.  Such a file can be used
      via $MSFI record.
