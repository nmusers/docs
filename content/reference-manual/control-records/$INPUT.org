...
SDF in SIZES. See [[file:/docs/reference-manual/api/memory/][SIZES]]), numerals (0-9), and character '_', beginning
with a letter [fn:1].
...
#+begin_src perl
   ...
   REPL_
#+end_src
Here =XVID='s are [[file:/docs/reference-manual/data/items/#evid][extra EVIDs]].
...
If the [[file:/docs/reference-manual/data/#data-time][label DATE]] (or DAT1, DAT2, or DAT3) is used,  DATE=DROP  causes
