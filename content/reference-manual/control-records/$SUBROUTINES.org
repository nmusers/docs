...
- ADVAN14 uses CVODES from the LLNL SUNDIALS  system  for  ordinary
  ...
  make  modifications  to  ~pr/CVODEU.f90~. See ~guides/cvs_guide.pdf~
  and ~guides/cv_guide.pdf~.
...
- ADVAN18 uses the DDE_SOLVER delay differential equation solver. See
  ...
  Solvers with the ddexpand program. See also ~guides/ddes_f90.pdf~.
...
- By default, the initial conditions  (i.e.,  compartment  amounts)  are
 ...
 See also [[file:/docs/user-guide/advanced/abbr_block/#compartment-initialization][Compartment initialization block]], [[file:/docs/reference-manual/data/#ss-dose][steady state dose]],
...
- ADVAN15  uses IDA from the LLNL SUNDIALS system for differential-alge-
 ...
 See ~guides/idas_guide.pdf~ and ~guidesida_guide.pdf~, and
 INTRODUCTION TO NONMEM 7: Another New  Differential Equation Solving Method: IDAS (ADVAN15).
