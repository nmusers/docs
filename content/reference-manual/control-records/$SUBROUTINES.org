...
- TOLERANCE values TOL (Relative Tolerance) is required; this can be
  ...
  TOL routine, which sets NRD=TOL. (See $SUBROUTINES, [[file:/docs/reference-manual/control-records/tol/][$TOL]]) With
  ...
  See options ATOL, TOLC, ATOLC, SSATOL, SSATOLC of the $SUBROUTINE and [[file:$TOL][$TOL]] records.
...
- By default, the initial conditions  (i.e.,  compartment  amounts)  are
 ...
 (See [[file:/docs/reference-manual/control-records/model/][$MODEL]], [[file:/docs/reference-manual/control-records/pk/][$PK]], [[file:/docs/reference-manual/api/subroutines/#model][MODEL]], pk).
