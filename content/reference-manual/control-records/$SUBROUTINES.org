...
- TOLERANCE values TOL (Relative Tolerance) is required; this can be
  ...
  TOL routine, which sets NRD=TOL. (See $SUBROUTINES, @@html:<a href="/docs/reference-manual/control-records/tol/">$TOL</a>@@) With
  ...
  See options ATOL, TOLC, ATOLC, SSATOL, SSATOLC of the $SUBROUTINE and @@html:<a href="$TOL">$TOL</a>@@ records.
...
- By  default,  the  initial  conditions (i.e., compartment amounts) are
 ...
 (See @@html:<a href="/docs/reference-manual/control-records/model/">$MODEL</a>@@, @@html:<a href="/docs/reference-manual/control-records/pk/">$PK</a>@@, @@html:<a href="/docs/reference-manual/api/subroutines/#model">MODEL</a>@@, @@html:<a href="/docs/reference-manual/api/subroutines/#PK">PK</a>@@, @@html:<a href="/docs/reference-manual/api/variables/#initial-steady-state-i_ss-issmod">Initial Steady State: I_SS,ISSMOD</a>@@).
...
- With  NONMEM  7.4,  ATOL  may  be  specified  for  ADVAN9 and
  ...
  option of the $ESTIMATION and  @@html:<a href="/docs/reference-manual/control-records/covar/">$COVARIANCE</a>@@ records.
...
- By default, the initial conditions  (i.e.,  compartment  amounts)  are
 ...
 (See @@html:<a href="/docs/reference-manual/control-records/model/">$MODEL</a>@@, @@html:<a href="/docs/reference-manual/control-records/pk/">$PK</a>@@, @@html:<a href="/docs/reference-manual/api/subroutines/#model">MODEL</a>@@, pk).
...
earlier versions of NONMEM 7, SS13 was used with ADVAN13.)
  ...
  + With NONMEM 7.4, values of TOL and ATOL may be specified  for
    ...
    SSATOLC of the $SUBROUTINE and @@html:<a href="/docs/reference-manual/control-records/tol/">$TOL</a>@@ records, and the TOL routine.
...
See also the @@html:<a href="/docs/reference-manual/control-records/covar/#covariance-tol">TOL</a>@@ option of the $COVARIANCE record. Required.

*** ATOL=n
      Specifies  the  absolute  tolerance for ADVAN9, ADVAN13, ADVAN14,
      ADVAN15, ADVAN16, ADVAN17, and  ADVAN18.   Optional.  Default  is
      1.0E-12.   See  also  the  @@html:<a href="/docs/reference-manual/control-records/estimation/#atol">ATOL  option</a>@@  of  the  $ESTIMATION and
      $COVARIANCE records.
