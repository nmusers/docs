...
template to provide the prior density function. Set $SUBR
OTHER=OMEGA_STD_PRIORU.f90 to use the user modified template.
...
template to provide the prior density function. Set $SUBR
OTHER=SIGMA_STD_PRIORU.f90 to use the user modified template.
