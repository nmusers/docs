...
****  ICMAX=n
   ...
   prior to calling the subroutine.  (See @@html:<a href="/docs/reference-manual/api/variables/#prior-simulation-icmax">PRIOR Simulation: ICMAX</a>@@).
...
#+end_src
 ...
 (See TNPRI, @@html:<a href="/docs/reference-manual/api/subroutines/#prior">PRIOR</a>@@).
