...
*** ETABARCHECK | NOETABARCHECK
ETABARCHECK: there is an etabar statistic (See etabar) from a  previous  problem,
...
(See etabar) relates to a hypothesis test that the true etabar is 0.
This  is the default.
