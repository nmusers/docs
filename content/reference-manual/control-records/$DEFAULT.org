...
*** NOSUB=[-1|0|1]
      ...
      in the problem.  This is the default. (See [[file:/docs/reference-manual/control-records/abbrev/][$ABBREVIATED]]).
      ...
      the  next  ~$EST~  record in the problem unless otherwise re-specified.
