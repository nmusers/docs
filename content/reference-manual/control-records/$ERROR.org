...
See [[file:/docs/reference-manual/control-records/abbrev/#headline-4][COMRES]] for details, in particular ~COMRES=-1~; see  [[file:/docs/reference-manual/abbr/#calling_protocol][Calling protocol]] on when ~ERROR~ is called.
