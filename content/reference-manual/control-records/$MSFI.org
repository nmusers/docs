...
*** MSFTEST | NOMSFTEST
MSFTEST: prevents an MSF file from being utilized in a subsequent  control
...
*** NEW
When  the problem that created the MSF file has successfully completed, calling for a resumed or new estimation is prevented when
