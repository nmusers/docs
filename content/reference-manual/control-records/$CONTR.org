...
See also @@html:<a href="/docs/reference-manual/control-records/mix/">$MIX</a>@@) These routines are called with individual records.
...
With  the  above  sample  $CONTR  record,  the following code might be
 ...
 individual record. (See @@html:<a href="/docs/reference-manual/api/memory/">SIZES</a>@@).
