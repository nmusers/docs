...
See also [[file:/docs/reference-manual/control-records/mix/][$MIX]]) These routines are called with individual records.
...
With  the  above  sample  $CONTR  record,  the following code might be
 ...
 individual record. (See [[file:/docs/reference-manual/api/memory/][SIZES]]).
