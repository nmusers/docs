...
listed in NMPRD4.  In this regard, see also section IV.H.
...
abbreviated code (see section IV.E.2). It defines the SAVE region of NMPRD4.
...
***  COMSAV= n2
      ...
      (See [[file:/docs/user-guide/advanced/abbr_block/#copying-block][copying block]]).
...
#+end_src
      ...
      (See [[file:/docs/techniques/dowhile/][DOWHILE block]]).
...
***  PROTECT
     ...
     (See [[file:/docs/techniques/protect/][PROTECT]]).
