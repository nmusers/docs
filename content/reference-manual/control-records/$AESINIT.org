...
See @@html:<a href="/docs/reference-manual/abbr/">abbreviated code</a>@@ for general rules. Specific rules follow.
...
- Calling protocol:
  ...
  phrase may be used instead of CALLFL, and either upper or lower case
  may be used. E.g.,
  #+begin_src perl
  $AESINIT (ONCE PER IR)     ;#  same as CALLFL=1
  $AESINIT (EVERY EVENT)     ;#  same as CALLFL=-1 (default)
  #+end_src
  See @@html:<a href="/docs/reference-manual/abbr/#calling_protocol">caling protocols</a>@@  for details.
