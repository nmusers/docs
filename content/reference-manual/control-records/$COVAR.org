...
*** SIGL=n, SIGLO=n (NM72)
      ...
      Covariance step.  The step size for evaluating the R matrix (central difference second derivative) is set to SIGL/4.  If only the
      ...
      definiteness issues.
      By default, values specified on the @@html:<a href="/docs/reference-manual/control-records/estimation/">$ESTIMATION record</a/>@@ are used.

      SIGL and SIGLO have no relevance to the Covariance  step  results for a BAYES method.
...
See also @@html:<a href="/docs/reference-manual/control-records/estimation/">$ESTIMATION record</a/>@@ and nmfe7 command.
...
:END:
      See @@html:<a href="/docs/reference-manual/control-records/estimation/#estm-ranmethod">the corresponding option of the $ESTIMATION record</a>@@ for importance sampling in EM analysis.
...
*** FORMAT=s (NM75)
      ...
      the format @@html:<a href="/docs/reference-manual/control-records/#format-s1pe11">FORMAT=s1PE11.4</a>@@.
...
*** SIRPARAFPRINT=n (NM74)
      ...
      See also @@html:<a href="/docs/reference-manual/control-records/estimation/">$ESTIMATION  record</a>@@
      and nmfe7 command.
