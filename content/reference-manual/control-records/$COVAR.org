...
*** SIGL=n, SIGLO=n (NM72)
      ...
      definiteness issues.
      By default, values specified on the [[file:/docs/reference-manual/control-records/estimation/][$ESTIMATION record</a/>@@ are used.
...
See also [[file:/docs/reference-manual/control-records/estimation/][$ESTIMATION record</a/>@@ and nmfe7 command.
