...
*** FORMAT=s (NM75)
      ...
      the format help and Introduction to NONMEM 7, FORMAT=s1PE11.4.
...
*** POSDEF=n (NM75)
      ...
      will  be  forced positive definite, by method of shifting the eigenvalues by an amount slightly greater than  the  most  negative
      ...
      The preconditioning method is a more sophisticated, but time-consuming  method of making the R matrix positive definite (See PRECOND).
      Default is 0.
