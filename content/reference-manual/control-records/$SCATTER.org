...
(See @@html:<a href="/docs/reference-manual/control-records/table/">$TABLE</a>@@).
...
*** NOSUB=[0|1]
      ...
      (See @@html:<a href="/docs/reference-manual/control-records/abbrev/">$ABBREVIATED</a>@@).  This is the default.   With  NOSUB=1,  label
