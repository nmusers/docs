...
COMSAV=n2 (option of @@html:<a href="/docs/reference-manual/control-records/abbrev/">$ABBREVIATED</a>@@ record): values of variables displayed  in  tables  and  scatterplots  are
      ...
      (See @@html:<a href="/docs/user-guide/advanced/abbr_block/#copying-block">copying block</a>@@). NM-TRAN causes the generated routines to store the value of @@html:<a href="/docs/reference-manual/api/variables/#comres-comsav">COMSAV</a>@@ at ICALL=1.
...
COMSAV=n2 (in user written code):
 ...
 (See @@html:<a href="/docs/reference-manual/api/variables/#pred-defined-variables">PRED-Defined Variables</a>@@, @@html: <a href="/docs/reference-manual/abbr/">abbreviated code</a>@@).
...
Data is used also in @@html:<a href="/docs/reference-manual/api/variables/#mix-data">MIX</a>@@.
...
When  with  a given data record, either of the limits CTLO or CTUP are
 ...
 (See @@html:<a href="/docs/reference-manual/api/variables/#ctlo">CTLO</a>@@, @@html:<a href="/docs/reference-manual/api/variables/#ctup">CTUP</a>@@)

 (See @@html:<a href="/docs/user-guide/advanced/abbr_block/#copying-block">copying</a>@@, @@html:<a href="/docs/user-guide/advanced/abbr_block/#expectation-block">expectation</a>@@, @@html:<a href="/docs/user-guide/advanced/abbr_block/#data-average-block">data average </a>@@ blocks)
...
PRINFN  is  a module for INFN-defined variables.  It contains an array
 ...
 NMPRD4.  (See @@html:<a href="/docs/reference-manual/api/variables/#pred-defined-variables">PRED-defined variables</a>@@).
...
(See @@html:<a href="/docs/reference-manual/api/subroutines/#ccontr">CCONTR</a>@@)
...
With NONMEM 7, the additional output file root.phi contains the same information. (See @@html:<a href="/docs/reference-manual/files/#addi-output">additional output files</a>@@).
...
- NWIND
      ...
      conjunction with calls to PASS.  (See @@html:<a href="/docs/reference-manual/api/subroutines/#pred">PRED</a>@@, @@html:<a href="/docs/reference-manual/api/variables/#newind">NEWIND</a>@@).
...
- The  EPRED_,  ERES_, EWRES_, NPD_, NPDE_, ECWRES_ items are calculated
 ...
 are of interest.  (See @@html:<a href="/docs/reference-manual/control-records/table/">$TABLE</a>@@).
...
by  specifying their names (without the underscore) on a $TABLE statement.
 ...
 (See @@html:<a href="/docs/reference-manual/api/variables/">PRED, RES, WRES</a>@@).
...
code for @@html:<a href="/docs/user-guide/advanced/abbr_block/#initialization-finalization-block">Initialization-Finalization blocks</a>@@.
 ...
 (See @@html:<a href="/docs/reference-manual/control-records/super/">$SUPER</a>@@).
...
When with a given data record, either of the limits YLO or YUP are set
 ...
 (See @@html:<a href="/docs/reference-manual/api/variables/">YLO, YUP</a>@@)

 (See @@html:<a
 href="/docs/user-guide/advanced/abbr_block/#copying-block">copying</a>@@, @@html:<a href="/docs/user-guide/advanced/abbr_block/#expectation-block">expectation</a>@@, @@html:<a href="/user-guide/advanced/abbr_block/#data-average-block">data average</a>@@ blocks)
...
NETAS_ is described in Parameter dimensions.
 ...
 (See @@html:<a href="/docs/reference-manual/api/variables/#parameter-dimensions">Parameter dimensions</a>@@).

At  run and problem initialization and at problem finalization use the variables OMEGAF and SIGMAF.
 (See @@html:<a href="/docs/reference-manual/api/variables/#parameter-values-init-final">Parameter values: Initial and Final</a>@@).
...
- MIXP
 ...
 (See @@html:<a href="/docs/reference-manual/api/variables/#mixnum-mixest-mixp">MIXNUM,MIXEST,MIXP</a>@@)

 (See @@html:<a href="/docs/reference-manual/api/subroutines/#mix">MIX</a>@@, mixture model example).
...
- At ICALL = 2, the values of these variables  should not be used
  ...
  values. (See @@html:<a href="/docs/reference-manual/api/variables/#comact">COMACT</a>@@,@@html:<a href="/docs/reference-manual/api/variables/#comres-comsav">COMSAV</a>@@)
...
SIMEPS is only relevant when correlations are stored in @@html:<a href="/docs/reference-manual/api/variables/#corrl2">CORRL2</a>@@.
...
blocks (epsilons sets) based on how Y is evaluated.
 ...
 (See @@html:<a href="/docs/reference-manual/api/variables/#simeps-error">Simulation:_SIMEPS_Error_Code</a>@@).
...
- NETEXT:
  + NETEXT=0 to 3: the number of lines of text of  an  error  message
    stored by PRED in ETEXT (See @@html:<a href="/docs/reference-manual/api/variables/#pred-error">PRED Error Message</a>@@).
...
- PREDPP will not set these values; only the EXIT statement in
  ...
  simulation, (See @@html:<a href="/docs/user-guide/advanced/abbr_block/#simulation-block">Simulation Block</a>@@) and look for "Simulation Error Forgiveness".
...
- ETEXT: user message which appears as part of the PRED error message.
  ...
  NETEXT. (See @@html:<a href="/docs/reference-manual/api/variables/#pred-exit">PRED Exit Code</a>@@)
...
@@html:<a href="/docs/reference-manual/api/variables/#ctlo">CTLO</a>@@ may be used in conjunction with CTUP.

@@html:<a href="/docs/reference-manual/api/variables/#pr-ct">PR_CT</a>@@ is the estimated probability that an observation will be of the category in question.
...
@@html:<a href="/docs/reference-manual/api/variables/#ctup">CTUP</a>@@ may be used in conjunction with CTLO.
...
- When F_FLAG/=0 for an observation within an individual record,
  ...
  within the individual record. (See @@html:<a href="/docs/reference-manual/api/variables/#corrl2">Correlation Across L2 Records</a>@@).
...
@@html:<a href="/docs/reference-manual/api/variables/#pr-y">PR_Y</a>@@ is the estimated probability that an observation will fall within (or  outside) the  interval.
...
- RPTO: the "repetition output value", can be used  in PRED, or as a
  ...
  + RPTO=n (n between 1 and 5): the current record is thus marked as a
    ...
    will be repeated.  See the repeat data item (See @@html:<a href="/docs/reference-manual/data/#rpt_">RPT_</a>@@).
...
(See @@html:<a href="/docs/reference-manual/control-records/table/">$TABLE</a>@@, @@html:<a href="/docs/reference-manual/control-records/scatter/">$SCATTER</a>@@).  Values are stored by PRED and by subroutines
of PREDPP. A SAVE region of NMPRD4 may be designated; (See @@html:<a href="/docs/reference-manual/api/variables/#comact">COMACT</a>@@,@@html:<a href="/docs/reference-manual/api/variables/#comres-comsav">COMSAV</a>@@).
...
(See @@html:<a href="/docs/reference-manual/api/variables/#infn-defined-variables">INFN-defined_variables</a>@@.)
...
(See @@html:<a href="/docs/reference-manual/api/modules/">NONMEM modules</a>@@).
...
#+end_src
- NACTIV: NACTIV = number of ETAs in the problem - NRETA. (See @@html:<a href="/docs/reference-manual/api/variables/#non-active-eta">non-active ETA list for PRED</a>@@). It is the number of ETAs that NONMEM is currently
...
- INTFLG. (ADVAN6, SS6, ADVAN8, ADVAN13, ADVAN14, ADVAN16, ADVAN18).
  ...
  the LVOUT array. (See @@html:<a href="/docs/reference-manual/api/variables/#non-active-eta">non-active ETA list for PRED</a>@@).
...
- DOSTIM
  ...
  + DOSTIM>0: this call to PK occurs at a non-event dose time DOSTIM,
    ...
    D2DOST, and DOSREC contain values of interest.  (See @@html:<a href="/docs/reference-manual/api/variables/#dose-record-dosrec">Dose Record: DOSREC</a>@@).
...
items are from the initiating dose event record.   (The  @@html:<a href="/docs/reference-manual/control-records/bind/">$BIND</a>@@  record may be used to override this)
...
(See @@html:<a href="/docs/reference-manual/api/variables/#dostim">Dose Time Non-Event: DOSTIM</a>@@).
...
- IDEFD: DES may set IDEFD when ICALL = 1, as follows.
  + IDEFD(1) may optionally be set by DES to indicate how many thetas
    ...
    (See @@html:<a href="/docs/reference-manual/api/variables/#des-aes-theta">DES_AES:THETA</a>@@).

  + When IDEFD(1)  is  set by DES to -9, PREDPP copies all thetas in
    the  problem  to  THETAS  (See @@html:<a href="/docs/reference-manual/api/variables/#des-aes-theta">DES_AES:THETA</a>@@).   With   NM-TRAN,
...
(See @@html:<a href="/docs/reference-manual/api/variables/#des-aes-icall">DES_AES:_ICALL,IDEFD,IDEFA</a>@@).
...
- When I_SS or ISSMOD is set, even if only to 0,  or  verbatim  code
 ...
 (See @@html:<a href="/docs/reference-manual/control-records/model/">$MODEL</a>@@, @@html:<a href="/docs/reference-manual/api/subroutines/#model">MODEL</a>@@).
