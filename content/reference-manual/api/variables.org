...
Data is used also in [[file:/docs/reference-manual/api/variables/#mix-data][MIX]].
...
- IFIRSTEM: with  NONMEM  7.2  and  higher, first-partial
  ...
  NOFASTDER of the [[file:/docs/reference-manual/control-records/abbrev/][$ABBREVIATED]] record prevents NM-TRAN from  doing
...
- MIXP
 ...
 (See [[file:/docs/reference-manual/api/subroutines/#mix][MIX]], mixture model example).
...
- PREDPP will not set these values; only the EXIT statement in
  ...
  simulation, (See [[file:/docs/user-guide/advanced/abbr_block/#simulation-block][Simulation Block]]) and look for "Simulation Error Forgiveness".
...
times is given by constant PCT in file SIZES (See [[file:/docs/reference-manual/api/memory/][SIZES]]).
