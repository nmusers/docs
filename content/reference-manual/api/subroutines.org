...
Also see @@html:<a
 href="/docs/reference-manual/api/variables/">variables in NONMEM
 modules</a>@@, @@html:<a href="/docs/reference-manual/api/modules/#nm-pred-mod">NONMEM-PRED modules, and  PREDPP modules</a>@@, particularly
...
tion to be made available (See  MIX_CONTR:_TEMPLT)
