...
global  vari- ables. In particular:
...
appear  in  the model and have nonzero-variances) in the PRIOR
subroutine (See PRIOR_Simulation:_Parameters).  However, this  need
