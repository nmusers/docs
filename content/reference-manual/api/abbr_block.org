...
See also: @@html:<a href="/reference-manual/api/subroutines/#PK">PK</a>@@.
...
PRED_IGNORE_DATA to a non-zero value within $INFN, @@html:<a href="/reference-manual/control-records/pk">$PK</a>@@., or $PRED,  for
