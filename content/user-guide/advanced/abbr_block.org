...
scatterplot and located in the SAVE region (See save_region (and the F
...
- ICALL=1: Superproblem and Problem initialization. ICALL is set to 1
  ...
  If 1-3 are true, do superproblem initialization (See Problem_Iteration_Counters).
...
- The following variables may be used on the right (their values  change
  ...
  + NPROB,  IPROB,  S1NUM, S2NUM, S1NIT, S2NIT, S1IT, S2IT (See Problem_Iteration_Counters).
