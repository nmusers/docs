...
arguments.  Use only NWPRI for the new $ESTIMATION methods of NONMEM 7.
...
### ESTIMATION or SIMULATION {#estimation-or-simulation}
...
### DISPLAY[=ALL|CNT] {#display-all-cnt}
