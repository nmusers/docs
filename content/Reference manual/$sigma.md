...
### $SIGMA   [DIAGONAL(n)] [ v11 v22 v33 ... vnn ] {#sigma-diagonal--n--v11-v22-v33-dot-dot-dot-vnn}
...
### $SIGMA BLOCK(n) [ v11 v21 v22 v31 v32 v33 ... vn1 vn2 ... vnn ] {#sigma-block--n--v11-v21-v22-v31-v32-v33-dot-dot-dot-vn1-vn2-dot-dot-dot-vnn}
...
### $SIGMA BLOCK(n) SAME(m) {#sigma-block--n--same--m}
...
### $SIGMA BLOCK(n) VALUES(diag,odiag) {#sigma-block--n--values--diag-odiag}
...
### $SIGMA label=value (NM75) {#sigma-label-value--nm75}
...
### $SIGMA  BLOCK(n) NAMES  (label1,...,labeln)  VALUES  (odiag,diag) {#sigma-block--n--names--label1-dot-dot-dot-labeln--values--odiag-diag}
...
### $SIGMA  SCALE(scalevalue) (NM760) {#sigma-scale--scalevalue----nm760}
...
sion  of  sigma  block.  Rather than always re-calculate by hand,
