...
### NCOMPARTMENTS=n1 {#ncompartments-n1}
...
### NEQUILIBRIUM=n2 {#nequilibrium-n2}

Number of equilibrium compartments.  Default: 0


### NPARAMETERS=n3 {#nparameters-n3}
...
### COMPARTMENT= ([name] [attribute1] [attribute2] ...) {#compartment--name-attribute1-attribute2-dot-dot-dot}
...
### LINK compname [TO|AND] compname BY k [l] {#link-compname-to-and-compname-by-k-l}
...
### SYMBOLIC LABEL SUBSTITUTIONS OF MODEL COMPARTMENTS  (NM75) {#symbolic-label-substitutions-of-model-compartments--nm75}
...
Guide IV, section V.C.4


## REFERENCES {#references}

Guide VI, section VI.B
