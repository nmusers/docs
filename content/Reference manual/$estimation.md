...
### BOOTDATA=[0|1] (NM75) {#bootdata-0-1--nm75}
...
### CONSTRAIN=n (NM72) {#constrain-n--nm72}
...
### CTYPE=[0|1|2|3|4] {#ctype-0-1-2-3-4}
...
### DERCONT=[0|1] (NM73) {#dercont-0-1--nm73}
...
### DF=n The proposal density is to be a t distribution with n degrees  of {#df-n-the-proposal-density-is-to-be-a-t-distribution-with-n-degrees-of}

freedom.   Default is 0, a normal density.  Used with the IMP and
IMPMAP methods.


### DFS=n (NM73) {#dfs-n--nm73}
...
### ETASAMPLES=[0|1] (NM74) {#etasamples-0-1--nm74}
...
### EVALSHRINK=0 (NM760)                                                   | {#evalshrink-0--nm760}

By  default,  when  MAXEVAL=0,  and population parameters are not |
inputted from an MSF file (using the $MSFI  record),  Etabar  and |
shrinkage information is not calculated and displayed in the NON- |
MEM report file.  If you wish to have this information  displayed |
when MAXEVAL=0, then set EVALSHRINK=1 on the $EST record.         |
...
### NOFO Requests that the First-Order Model not be used with METHOD=1 and {#nofo-requests-that-the-first-order-model-not-be-used-with-method-1-and}

CENTERING.  This is the default.


### FPARAFILE=filename (NM74) {#fparafile-filename--nm74}
...
### GRD=t1v1(n1):t2v2(n2):t3v3(n3)... {#grd-t1v1--n1--t2v2--n2--t3v3--n3--dot-dot-dot}
...
### GRID=(nr,ns,r0,r1) {#grid--nr-ns-r0-r1}

Optional.  May  be  used with STIELTJES.  For nr, ns, r0, and r1,
see the detailed description to option STIELTJES below.  Briefly,
a  grid  is  obtained by first taking the interval [r0,r1] of the
length axis and dividing this interval into  nr  equal  subinter-
vals.   ns  may be thought of as the number of points in a single
quadrant of a 2-dimensional ellipse in n-space.  Constraints  are
nr&lt;=100,  ns&lt;=9999,  0&lt;r0&lt;r1&lt;1.   If  r1&gt;.9999,  there is no tail
region.  nr and ns should be integers.  The default  values  are:
GRID=(3,1,.6,.9).
...
### IACCEPTL=x (NM74) {#iacceptl-x--nm74}
...
### ISAMPEND=n (NM73) {#isampend-n--nm73}
...
### ISAMPLE_M1A=n(NM72) {#isample-m1a-n--nm72}
...
### ISCALE_MIN=x ISCALE_MAX=x (NM72) {#iscale-min-x-iscale-max-x--nm72}
...
### KAPPA=x (NM74) {#kappa-x--nm74}

Used with NUTS method.  Default is 1.


### KNUTHSUMOFF=n] (NM74) {#knuthsumoff-n--nm74}
...
### LEVCENTER=[0|1] (NM75) {#levcenter-0-1--nm75}
...
### LEVOBJTYPE=[0|1] (NM751) {#levobjtype-0-1--nm751}

If LEVOBJTYPE=0,  then  for  IMP/ITS/FOCE/Laplace,  the  reported
ojective  function (and what is used for estimation) is the aver-
age of two cycles of optimization.  The first optimization floats
...
only that of the second optimization cycle. The LEVOBJTYPE=0 pro-
vides the most consistent results between FOCE/Laplace and the EM
...
### MADAPT=n (NM74) {#madapt-n--nm74}

Used with NUTS method.  Default is -1.


### MAPCOV=1 (NM74) {#mapcov-1--nm74}

Unused. The default is 1.


### MAPINTER=n (NM72) {#mapinter-n--nm72}
...
### MAPITERS=[0|1] (NM75) {#mapiters-0-1--nm75}
...
NUTS (NM74)
     ...
     method are  listed  alphabetically  under  NUTS\_....   Other
...
### MUM=v1(n1):v2(n2):v3(n3)... {#mum-v1--n1--v2--n2--v3--n3--dot-dot-dot}
...
### NONINFETA=[0|1] (NM73) {#noninfeta-0-1--nm73}
...
### NUMDER=[0|1|2|3] (NM73) {#numder-0-1-2-3--nm73}
...
### NUTS_BASE (NM74) {#nuts-base--nm74}

See Guide INTRODUCTION TO NONMEM 7. Default is 0.025.


### NUTS_DELTA  (NM74) {#nuts-delta--nm74}

See Guide INTRODUCTION TO NONMEM 7. Default is 0.8


### NUTS_EPARAM  (NM74) {#nuts-eparam--nm74}

See Guide INTRODUCTION TO NONMEM 7. Default is 0


### NUTS_GAMMA  (NM74) {#nuts-gamma--nm74}

See Guide INTRODUCTION TO NONMEM 7. Default is 0.05


### NUTS_INIT  (NM74) {#nuts-init--nm74}

See Guide INTRODUCTION TO NONMEM 7. Default is 0.075.


### NUTS_MASS  (NM74) {#nuts-mass--nm74}

See Guide INTRODUCTION TO NONMEM 7. Default is B


### NUTS_MAXDEPTH  (NM74) {#nuts-maxdepth--nm74}

See Guide INTRODUCTION TO NONMEM 7. Default is 10


### NUTS_OPARAM  (NM74) {#nuts-oparam--nm74}

See Guide INTRODUCTION TO NONMEM 7. Default is 1


### NUTS_REG  (NM74) {#nuts-reg--nm74}

See Guide INTRODUCTION TO NONMEM 7. Default is 0.0


### NUTS_SPARAM  (NM74) {#nuts-sparam--nm74}

See Guide INTRODUCTION TO NONMEM 7. Default is 1


### NUTS_STEPINTER (NM74) {#nuts-stepinter--nm74}

See Guide INTRODUCTION TO NONMEM 7. Default is 0


### NUTS_STEPITER (NM74) {#nuts-stepiter--nm74}

See Guide INTRODUCTION TO NONMEM 7. Default is 1


### NUTS_TERM (NM74) {#nuts-term--nm74}

See Guide INTRODUCTION TO NONMEM 7. Default is 0.05


### NUTS_TEST (NM74) {#nuts-test--nm74}

See Guide INTRODUCTION TO NONMEM 7. Default is 0


### NUTS_TRANSFORM (NM74) {#nuts-transform--nm74}
...
fraction of the time. See OSAMPLE_M2=. Default is


### OLKJDF=n (NM74) {#olkjdf-n--nm74}
...
### THETABOUNDTEST, OMEGABOUNDTEST, SIGMABOUNDTEST {#thetaboundtest-omegaboundtest-sigmaboundtest}
...
### NOTHETABOUNDTEST, NOOMEGABOUNDTEST, NOSIGMABOUNDTEST {#nothetaboundtest-noomegaboundtest-nosigmaboundtest}
...
algorithm  and an inverse Wishart proposal density that has vari-
ance based on the previous samples. If n &lt; 0 this indicates that


### OSAMPLE_M2=n {#osample-m2-n}
...
### PARAFILE=filename {#parafile-filename}
...
### PARAFPRINT=n (NM74) {#parafprint-n--nm74}
...
### PSCALE_MIN=n, PSCALE_MAX=n (NM74) {#pscale-min-n-pscale-max-n--nm74}
...
### RANMETHOD=[n|S|m|P] (NM72) {#ranmethod-n-s-m-p--nm72}
...
### SADDLE_HESS=n (NM74) {#saddle-hess-n--nm74}
...
### SADDLE_RESET=n (NM74) {#saddle-reset-n--nm74}
...
### CLOCKSEED=[0|1] (NM75) {#clockseed-0-1--nm75}
...
### SELECT=[0|1|2|3] (NM73) {#select-0-1-2-3--nm73}
...
### SORT Individual contribution to the objective function value and indi- {#sort-individual-contribution-to-the-objective-function-value-and-indi}
...
Then numerical integration is used to obtain  second-stage  esti-
mates.  A more detailed description of STIELTJES follows:
...
$ESTIM record in the usual way to obtain  fairly  reliable  esti-
mates.   Include the METHOD=CONDITIONAL option on the $ESTIMATION
...
parameter estimates. Numerical integration is used to obtain sec-
ond-stage estimates.  The integral will  be  exact  in  the  case
...
still  evaluated at many values of eta.  Generally though, suffi-
ciently good estimates are obtained by using conditional  estima-
tion  methods, or even the First-Order Estimation method, and one
...
coordinates, the length of a point P is given in fractile units -
the  first-stage  estimate  of the fraction of area enclosing all
...
the total number of orthants.  See the description to option GRID
above to specify grid information.


### SVARF=x (NM74) {#svarf-x--nm74}
...
### MUFIRSTREC (NM74) {#mufirstrec--nm74}
...
Guide I, section C.3.5.1


## REFERENCES {#references}

Guide II, section E , F


## REFERENCES {#references}

Guide IV, section III.B.14 , IV.G


## REFERENCES {#references}

Guide V, section 9.4.1, , 13.2


## REFERENCES {#references}

Guide VII, section I , II , III
