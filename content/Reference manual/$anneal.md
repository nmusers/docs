...
Required. Sets starting diagonal Omega values for purposes of simulated  annealing by NONMEM subroutine CONSTRAINT.
...
-), or a series of integers and ranges separated by comma.
