...
## $WARNINGS {#warnings}
 ...
 Control  Display  of  NM-TRAN Warning, Data Warning and Data
Error messages
...
### NONE Suppress all warning messages. {#none-suppress-all-warning-messages-dot}


### n    Sets  WARNINGMAXIMUM=n, ERRORMAXIMUM=n, DATAMAXIMUM=n.  May be 0, {#n-sets-warningmaximum-n-errormaximum-n-datamaximum-n-dot-may-be-0}

in which case it is the same as NONE.


### LIST Print a list of all possible warning messages.  When this  option {#list-print-a-list-of-all-possible-warning-messages-dot-when-this-option}
