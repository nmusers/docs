...
### SIGL=n  SIGLO=n (NM72) {#sigl-n-siglo-n--nm72}
...
### SIRSAMPLE=[numberlist] (NM74) {#sirsample-numberlist--nm74}
...
### SIRNITER=n (NM74) {#sirniter-n--nm74}

The number of times SIR sampling should occur.  Default is 1.


### SIRCENTER=n (NM74) {#sircenter-n--nm74}
...
### SIR_CAPCORR=x (NM75) {#sir-capcorr-x--nm75}
...
### SIRMINWT=x (NM75) {#sirminwt-x--nm75}


### SIRMAXWT=x (NM75) {#sirmaxwt-x--nm75}
...
### SIRSEED=n (NM75) {#sirseed-n--nm75}

Starting seed for SIR analysis (default=11456).


### SIRCLOCKSEED=[0|1] (NM75) {#sirclockseed-0-1--nm75}
...
### FILE=filename (NM74) {#file-filename--nm74}
...
### SIRTHBND=n (NM74) {#sirthbnd-n--nm74}
...
### SIRPARAFILE=filename {#sirparafile-filename}
...
### SIRPARAFPRINT=n (NM74) {#sirparafprint-n--nm74}
...
### PRECONDS=TOS (NM74) {#preconds-tos--nm74}
...
### CHOLROFF=n (NM74) {#cholroff-n--nm74}
...
Guide IV, section III.B.15


## REFERENCES {#references}

Guide V, section 9.4.2 , 10.6
