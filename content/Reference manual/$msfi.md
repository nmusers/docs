...
### NEW  When  the problem that created the MSF file has successfully com- {#new-when-the-problem-that-created-the-msf-file-has-successfully-com}
...
Guide II, section E.3

Guide III, section 3.2

Guide IV, section III.B.12
