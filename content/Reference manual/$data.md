...
### PRED_IGNORE_DATA (NM75) {#pred-ignore-data--nm75}
...
### WIDE Requests  that  FDATA  contain  single-line  records, and that at {#wide-requests-that-fdata-contain-single-line-records-and-that-at}
...
prets  the  input data.  If the REPL option of $DATA or the REPL\_
...
BLANKOK  restores  the  previous behavior.  There is no abbrevia-
tion. BLANKOK must be coded in full.


### MISDAT=r (NM74) {#misdat-r--nm74}
...
Part IV.)
The REPL option may be used with the REPL\_ data  item.   If  both
are  used  the REPL\_ data item applies first, and the REPL option
applies second.
See REPL\_ data item.
The REPL option and REPL\_ data item are meant  to  be  used  with
...
### NOFDATACSV (NM760)                                                     | {#nofdatacsv--nm760}
...
the following cases.  If REPL/REPL\_ is used, the replicated  form |
