...
### COMSAV= n2 ('common save') {#comsav-n2--common-save}
...
### DERIV2=NOCOMMON {#deriv2-nocommon}
...
### REPLACE left_string = right_string {#replace-left-string-right-string}
...
### DECLARE [INTEGER] [DOWHILE] name [(dimension [,dimension])] ... {#declare-integer-dowhile-name--dimension-dimension--dot-dot-dot}
