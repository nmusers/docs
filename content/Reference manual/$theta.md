...
### ([low,] init [,up] [FIXED]) {#low-init-up-fixed}
...
### label=value [FIXED] (NM75) {#label-value-fixed--nm75}
...
### NAMES (label ...)value ... (NM75) {#names--label-dot-dot-dot--value-dot-dot-dot--nm75}
