...
### SOURCE_EPS=n (NM75) {#source-eps-n--nm75}
...
### NEW  If  the  NEW  option  is  used,  the  vector of eta's (epsilon's) {#new-if-the-new-option-is-used-the-vector-of-eta-s--epsilon-s}
...
### SUPRESET|NOSUPRESET {#supreset-nosupreset}
...
### RANMETHOD=[n|S|m|P] {#ranmethod-n-s-m-p}
...
Guide IV, section III.B.13 , IV.I


## REFERENCES {#references}

Guide V, section 12.4.8


## REFERENCES {#references}

Guide  VI, section III.C , III.E , IV.B , IV.G.1
