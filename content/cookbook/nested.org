...
effect as fixed effects using THETAs (see [[https://github.com/nmusers/docs/tree/master/examples/superid3_6]["examples/superid3_6"]] and [[https://github.com/nmusers/docs/tree/master/examples/superid3_1]["examples/superid3_1"]]).
